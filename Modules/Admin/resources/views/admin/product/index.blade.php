                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td>
                          <div class="d-flex px-2 py-1">
                            <div class="d-flex flex-column justify-content-center">
                              <h6 class="mb-0 text-sm ms-4">{{$p->id}}</h6>
                            </div>
                          </div>
                        </td>
                        <td>
                        ...
                        <td>
                            <p class="text-xs font-weight-bold mb-0"  style="text-align: center;">{{number_format($p->price)}}</p>
                        </td>
                        <td>
                            <p class="text-xs font-weight-bold mb-0" style="text-align: center;">{{$p->category->name ?? 'N/A'}}</p>
                        </td>
                        <td class="align-middle text-center text-sm d-flex justify-content-center">
                          <a href="{{route('product.show', $p->id)}}" class="btn btn-primary" style="margin-right: 5px">Xem</a>
                          <a href="{{route('product.edit', $p->id)}}" class="btn btn-primary">Sửa</a>
                          <form action="{{route('product.destroy', $p->id)}}" method="post" style="margin-left: 5px">
                            @method('DELETE')
                            @csrf
