                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <p class="text-xs font-weight-bold mb-0">{{number_format($b->total_amount)}}</p>
                        </td>
                        <td>
                          <p class="text-xs font-weight-bold mb-0">{{$b->created_at->format('d/m/Y H:i')}}</p>
                      </td>
                      <td>
                        @if($b->status == 'Chờ xác nhận' || $b->status == 'Đang giao hàng')
                        <p class="text-xs font-weight-bold mb-0">
                          {{$b->status}}
                        </p>
                        @elseif($b->status == 'Hủy đơn')
                        ...
                        <td class="align-middle text-center text-sm d-flex justify-content-center">
                          <a href="{{route('bill.edit', $b->id)}}" class="btn btn-primary">Sửa</a>
                          <a href="{{route('bill.show', $b->id)}}" class="btn btn-primary">Xem</a>
                        </td>
                    </tr>
                    @endforeach
                    </tbody>
