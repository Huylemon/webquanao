                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <p class="text-xs font-weight-bold mb-0">{{$c->gender}}</p>
                        </td>
                        <td class="align-middle text-center text-sm d-flex justify-content-center">
                          <a href="{{route('category.edit', $c->id)}}" class="btn btn-primary">Sửa</a>
                          <form action="{{route('category.destroy', $c->id)}}" method="post" style="margin-left: 5px">
                            @method('DELETE')
                          @csrf
