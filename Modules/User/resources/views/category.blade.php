							...
							<div class="col">
								...
								<div class="product-grid">
									...
									<div class="product-item men mb-5" style="height:380px;">
										<a href="{{url('detailProduct', $p->id)}}" class=" discount product_filter">
											<div class="product_image">
												<img src="{{URL::to('/')}}/images/{{$p->image}}" alt="" style="height:250px">
											</div>
											<div class="favorite favorite_left"></div>
											@if($p->discount > 0)
                                        		<div class="product_bubble product_bubble_right product_bubble_red d-flex flex-column align-items-center"><span>-{{100 - intval(round(($p->discount/$p->price)*100))}}%</span></div>
                                    		@endif
											<div class="product_info">
												<h6 class="product_name text-truncate"><a href="">{{$p->name}}</a></h6>
												@if($p->discount > 0)
